...
SECRET_KEY = 'j4v!p^wzn8my-sepo3nublufsco(a8$$_(j-$92yq)qx(&qp@!'
...
INSTALLED_APPS = [
    'ddu_canteen.apps.DduCanteenConfig',
...
EMAIL_HOST = 'tyewatson0@gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_USE_SSL = True
EMAIL_HOST_PASSWORD = ''
DEFAULT_FROM_EMAIL = 'noreply@tehhet.com'
